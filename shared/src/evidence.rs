...
pub static CLAIMS: &[EvidenceEntry] = &[
    ...
    EvidenceEntry {
        ...
        grade: Strong,
        primary_citations: &[
            "Zatsiorsky & Kraemer 2020, Science and Practice of Strength Training (3rd ed., Human Kinetics); Haff & Triplett 2016, NSCA Essentials of Strength Training and Conditioning (4th ed.)",
            "Cormie, McGuigan & Newton 2011, Sports Med 41(1):17-38; Kawamori & Haff 2004, J Strength Cond Res 18(3):675-684",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: Strong,
        primary_citations: &["Meeusen et al. 2013, Med Sci Sports Exerc 45:186-205 (ECSS/ACSM)"],
        contradicting: &[],
        safety_critical: true,
        contested: None,
        review_months: 12,
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Cook & Purdam 2009, Br J Sports Med 43:409-416 (load-induced tendon pathology continuum)",
            "Silbernagel et al. 2007, Am J Sports Med 35(6):897-906 (pain-monitoring model)",
        ],
        contradicting: &[],
        safety_critical: true,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Eichner 1993, Phys Sportsmed 21(1):125-135 (neck-check rule)",
            "Meeusen et al. 2013, Med Sci Sports Exerc 45:186-205 (ECSS/ACSM consensus)",
        ],
        contradicting: &[],
        safety_critical: true,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: Moderate,
        primary_citations: &[
            "Schoenfeld, Grgic, Van Every & Plotkin 2021, Sports 9(2):32 (loading recommendations)",
            "Schoenfeld, Grgic, Ogborn & Krieger 2017, J Strength Cond Res 31(12):3508-3523 (load meta-analysis)",
        ],
    ...
    EvidenceEntry {
        ...
        primary_citations: &[
            ...
            "Bosquet et al. 2007, Med Sci Sports Exerc 39(8):1358-1365 (taper meta-analysis)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: Moderate,
        primary_citations: &[
            "Baar 2014, Sports Med 44(Suppl 2):S117-S125 (AMPK-mTOR molecular interference)",
            "Robineau et al. 2016, J Strength Cond Res 30(3):672-683 (recovery interval between concurrent sessions)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: Some("CQ-15"),
    ...
    EvidenceEntry {
        ...
        grade: Moderate,
        primary_citations: &[
            "Jones et al. 2013 (endurance-frequency dose-response for interference)",
            "Wilson et al. 2012, J Strength Cond Res 26(8):2293-2307 (concurrent-training meta-analysis)",
            "Doma, Deakin & Bentley 2017, Sports Med 47:2187-2200 (residual fatigue)",
            "Baar 2014, Sports Med 44(Suppl 2):S117-S125",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: Some("CQ-15"),
    ...
    EvidenceEntry {
        ...
        grade: Moderate,
        primary_citations: &[
            "Banister & Calvert 1975, Aust J Sports Med 7:57-61 (impulse-response fitness-fatigue model)",
    ...
    EvidenceEntry {
        ...
        grade: Moderate,
        primary_citations: &[
            "Cooper 1968, JAMA 203(3):201-204 (12-min run field test of VO2max)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: Moderate,
        primary_citations: &[
            "Bickel, Cross & Bamman 2011, Med Sci Sports Exerc 43(7):1177-1187 (adaptations maintained on reduced volume)",
            "Mujika & Padilla 2000, Sports Med 30(2):79-87 & 30(3):145-154 (detraining)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Armstrong et al. 2007, Med Sci Sports Exerc 39(3):556-572 (ACSM position stand on exertional heat illness)",
        ],
        contradicting: &[],
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Rippetoe & Kilgore 2011, Starting Strength (3rd ed., Aasgaard) (movement-pattern substitution)",
            "Schoenfeld, Grgic, Ogborn & Krieger 2017, J Strength Cond Res 31(12):3508-3523 (effort-matched loads preserve hypertrophy)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: Weak,
        primary_citations: &[
            "Maffetone 2010, The Big Book of Endurance Training and Racing (Skyhorse)",
        ],
        contradicting: &[
    ...
    EvidenceEntry {
        ...
        grade: Weak,
        primary_citations: &[
            "Buist et al. 2008, Am J Sports Med 36(1):33-39 (validation RCT; rule failed)",
            "Nielsen et al. 2014, J Orthop Sports Phys Ther 44(10):739-747",
        ],
    ...
    EvidenceEntry {
        ...
        grade: Weak,
        primary_citations: &[
            "McNulty et al. 2020, Sports Medicine 50:1813-1827",
            "Elliott-Sale et al. 2021, Sports Medicine 51:843-861",
        ],
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Rhea et al. 2003, Med Sci Sports Exerc 35(3):456-464 (dose-response by training age)",
            "Zatsiorsky & Kraemer 2020, Science and Practice of Strength Training (3rd ed., Human Kinetics)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: Moderate,
        primary_citations: &[
            "Matveyev 1981, Fundamentals of Sport Training & Bompa, Periodization: Theory and Methodology of Training (linear/novice)",
            "Rhea et al. 2003, Med Sci Sports Exerc 35(3):456-464 & Fleck & Kraemer, Designing Resistance Training Programs (DUP)",
            "Issurin 2010, Sports Med 40(3):189-206 (block); Simmons 2007, The Westside Barbell Book of Methods (conjugate)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: Moderate,
        primary_citations: &[
            "Zourdos et al. 2016, J Strength Cond Res 30(1):267-275 (RIR-based RPE)",
            "Helms et al. 2018, Front Physiol 9:247 (RPE-based load prescription)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: Weak,
        primary_citations: &[
            "Israetel, Hoffmann & Smith 2021, Scientific Principles of Hypertrophy Training (Renaissance Periodization)",
            "Rhea et al. 2003, Med Sci Sports Exerc 35(3):456-464 (training-age dose-response)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        primary_citations: &[
            "Israetel, Hoffmann & Smith 2021, Scientific Principles of Hypertrophy Training (Renaissance Periodization)",
            "Zourdos et al. 2016, J Strength Cond Res 30(1):267-275 (RIR accuracy)",
        ],
        contradicting: &[],
        safety_critical: true,
        contested: None,
    ...
    EvidenceEntry {
        ...
        primary_citations: &[
            "Israetel, Hoffmann & Smith 2021, Scientific Principles of Hypertrophy Training (Renaissance Periodization)",
            "Zourdos et al. 2016, J Strength Cond Res 30(1):267-275 (autoregulated proximity to failure)",
        ],
        contradicting: &[],
        safety_critical: true,
        contested: None,
    ...
    EvidenceEntry {
        ...
        primary_citations: &[
            "Israetel, Hoffmann & Smith 2021, Scientific Principles of Hypertrophy Training (Renaissance Periodization)",
            "Zourdos et al. 2016, J Strength Cond Res 30(1):267-275 (RPE/velocity as objective effort marker)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: Moderate,
        primary_citations: &[
            "Gonzalez-Badillo & Sanchez-Medina 2010, Int J Sports Med 31:347-352 (bar velocity as effort marker)",
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Israetel, Hoffmann & Smith 2021, Scientific Principles of Hypertrophy Training (Renaissance Periodization) (stimulus-to-fatigue exercise selection)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        primary_citations: &[
            "Israetel, Hoffmann & Smith 2021, Scientific Principles of Hypertrophy Training (Renaissance Periodization)",
            "Cook & Purdam 2009, Br J Sports Med 43:409-416 (load-related joint/tendon pain)",
        ],
        contradicting: &[],
        safety_critical: true,
        contested: None,
    ...
    EvidenceEntry {
        ...
        primary_citations: &[
            "Israetel, Hoffmann & Smith 2021, Scientific Principles of Hypertrophy Training (Renaissance Periodization)",
            "Mujika & Padilla 2000, Sports Med 30(2):79-87 & 30(3):145-154 (detraining lowers landmarks)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: Moderate,
        primary_citations: &[
            "Iversen, Norum, Schoenfeld & Fimland 2021, Sports Medicine 51:2079-2095 (No Time to Lift; time-efficient antagonist supersets)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Meeusen et al. 2013, Med Sci Sports Exerc 45:186-205 (ECSS/ACSM overtraining consensus)",
            "Pfitzinger & Douglas 2009, Advanced Marathoning (2nd ed., Human Kinetics)",
        ],
        contradicting: &[],
        safety_critical: true,
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Deci, Koestner & Ryan 1999, Psychol Bull 125(6):627-668 (positive verbal feedback)",
            "Williamson et al. 2022, Int Rev Sport Exerc Psychol 17(2):1050-1078 (process focus)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Deci, Koestner & Ryan 1999, Psychol Bull 125(6):627-668",
            "Carpentier & Mageau 2013, Psychol Sport Exerc 14(3):423-435 (change-oriented feedback)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Williamson et al. 2022, Int Rev Sport Exerc Psychol 17(2):1050-1078",
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Mountjoy et al. 2023, Br J Sports Med 57(17):1073-1097 (IOC RED-S consensus)",
            "Deci, Koestner & Ryan 1999, Psychol Bull 125(6):627-668 (rewarding behavior vs outcomes)",
        ],
        contradicting: &[],
        safety_critical: true,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Kraemer & Ratamess 2004, Med Sci Sports Exerc 36(4):674-688 (ACSM progression models; individualization principle)",
            "Deci, Koestner & Ryan 1999, Psychol Bull 125(6):627-668 (autonomy-supportive framing)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: Weak,
        primary_citations: &[
            "Bellenger et al. 2016, Sports Med 46(10):1461-1486 (resting-HR/HRV monitoring of fatigue)",
            "TrainingPeaks coaching guidance (trainingpeaks.com)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: Moderate,
        primary_citations: &[
            "Saw, Main & Gastin 2016, Br J Sports Med 50(5):281-291 (subjective wellness monitoring)",
            "Meeusen et al. 2013, Med Sci Sports Exerc 45:186-205",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Saw, Main & Gastin 2016, Br J Sports Med 50(5):281-291",
            "Plews et al. 2013, Sports Med 43(9):773-781 (HRV averaging/interpretation)",
        ],
        contradicting: &[],
        safety_critical: true,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Kraemer & Ratamess 2004, Med Sci Sports Exerc 36(4):674-688 (ACSM progression models)",
            "Mujika & Padilla 2000, Sports Med 30(2):79-87 & 30(3):145-154",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Mujika & Padilla 2000, Sports Med 30(2):79-87 & 30(3):145-154 (detraining time course)",
            "Bosquet et al. 2013, J Strength Cond Res 27(11):3090-3104 (return-from-detraining)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: Moderate,
        primary_citations: &[
            "Wilson et al. 2012, J Strength Cond Res 26(8):2293-2307",
            "Hickson 1980, Eur J Appl Physiol 45:255-263 (original interference study)",
            "Jones et al. 2013; Baar 2014, Sports Med 44(Suppl 2):S117-S125",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: Some("CQ-06"),
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Bickel, Cross & Bamman 2011, Med Sci Sports Exerc 43(7):1177-1187 (adaptations retained on ~1/3 volume)",
            "Blagrove, Howatson & Hayes 2018, Sports Med 48(5):1117-1149 (running economy maintenance)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: Moderate,
        primary_citations: &[
            "Foster 2001, J Strength Cond Res 15(1):109-115 (session-RPE monitoring)",
            "Meeusen et al. 2013, Med Sci Sports Exerc 45:186-205",
            "Plews et al. 2013, Sports Med 43(9):773-781 (HRV trend)",
        ],
        contradicting: &[
    ...
    EvidenceEntry {
        ...
        grade: Strong,
        primary_citations: &[
            "Zatsiorsky & Kraemer 2020, Science and Practice of Strength Training (3rd ed., Human Kinetics) (specificity / SAID)",
            "Simmons 2007, The Westside Barbell Book of Methods (over-specialization caution)",
        ],
    ...
    EvidenceEntry {
        ...
        grade: Moderate,
        primary_citations: &[
            "Simmons 2007, The Westside Barbell Book of Methods (conjugate variation selection)",
            "Zatsiorsky & Kraemer 2020, Science and Practice of Strength Training (3rd ed., Human Kinetics)",
        ],
        contradicting: &[],
        safety_critical: false,
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Simmons 2007, The Westside Barbell Book of Methods (weak-point/sticking-point training)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Zatsiorsky & Kraemer 2020, Science and Practice of Strength Training (3rd ed., Human Kinetics) (specificity of transfer)",
            "Haff & Triplett 2016, NSCA Essentials of Strength Training and Conditioning (4th ed.)",
        ],
        contradicting: &[
    ...
    EvidenceEntry {
        ...
        primary_citations: &[
            "TrainingPeaks coaching guidance (trainingpeaks.com)",
            "Meeusen et al. 2013, Med Sci Sports Exerc 45:186-205 (elevated resting HR as overreaching marker)",
        ],
        contradicting: &[],
        safety_critical: true,
        contested: None,
    ...
    EvidenceEntry {
        ...
        primary_citations: &[
            "Silbernagel et al. 2007, Am J Sports Med 35(6):897-906 (pain-monitoring model)",
            "Cook & Purdam 2009, Br J Sports Med 43:409-416 (tendon pathology continuum)",
        ],
        contradicting: &[],
        safety_critical: true,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: Moderate,
        primary_citations: &[
            "Karvonen, Kentala & Mustala 1957, Ann Med Exp Biol Fenn 35:307-315 (heart-rate reserve)",
            "Swain & Leutholtz 1997, Med Sci Sports Exerc 29(3):410-414 (%HRR = %VO2 reserve)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: Weak,
        primary_citations: &[
            "Coggan & Allen 2019, Training and Racing with a Power Meter (3rd ed., VeloPress) (%FTP zones)",
            "Stryd running power-zone documentation (stryd.com) (%Critical Power zones)",
        ],
    ...
    EvidenceEntry {
        ...
        primary_citations: &[
            "Pfitzinger & Douglas 2009, Advanced Marathoning (2nd ed., Human Kinetics)",
            "Canova & Arcelli 1999, Marathon Training: A Scientific Approach (IAAF/International Athletic Foundation)",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Magness 2014, The Science of Running (Origin Press)",
            "Hudson & Fitzgerald 2008, Run Faster from the 5K to the Marathon (Broadway Books)",
            "Lydiard & Gilmour, Running to the Top (Meyer & Meyer Sport)",
        ],
        contradicting: &[
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Galloway 2016, The Run-Walk-Run Method (Meyer & Meyer Sport)",
        ],
        contradicting: &[],
        safety_critical: true,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Ardern et al. 2016, Br J Sports Med 50(14):853-864 (consensus on return to sport)",
            "ACSM's Guidelines for Exercise Testing and Prescription (10th ed., 2018, Wolters Kluwer)",
        ],
        contradicting: &[],
        safety_critical: true,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: Moderate,
        primary_citations: &[
            "Bandura 1997, Self-Efficacy: The Exercise of Control (Freeman) (mastery experiences)",
            "Deci, Koestner & Ryan 1999, Psychol Bull 125(6):627-668",
        ],
        contradicting: &[],
        safety_critical: false,
    ...
    EvidenceEntry {
        ...
        primary_citations: &[
            "Mountjoy et al. 2023, Br J Sports Med 57(17):1073-1097 (IOC RED-S consensus)",
            "Warden, Davis & Fredericson 2014, J Orthop Sports Phys Ther 44(10):749-765 (bone stress injuries)",
        ],
        contradicting: &[],
        safety_critical: true,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Baar 2014, Sports Med 44(Suppl 2):S117-S125 (schedule priority quality when fresh)",
            "Robineau et al. 2016, J Strength Cond Res 30(3):672-683",
        ],
        contradicting: &[],
        safety_critical: false,
        contested: None,
    ...
    EvidenceEntry {
        ...
        grade: ExpertOpinion,
        primary_citations: &[
            "Issurin 2010, Sports Med 40(3):189-206 (block periodization of qualities)",
            "Baar 2014, Sports Med 44(Suppl 2):S117-S125",
        ],
        contradicting: &[],
        safety_critical: false,
    ...
    EvidenceEntry {
        ...
        primary_citations: &[
            "Mountjoy et al. 2023, Br J Sports Med 57(17):1073-1097 (IOC RED-S consensus)",
            "Warden, Davis & Fredericson 2014, J Orthop Sports Phys Ther 44(10):749-765",
        ],
        contradicting: &[],
        safety_critical: true,
        contested: None,
